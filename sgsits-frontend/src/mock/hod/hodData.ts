/**
 * MOCK: HOD Dashboard & Department Management Data
 * Consolidated from:
 *   src/data/mockHodData.ts  — Leave applications, timetable, attendance, result summary
 *   src/data/mockHodContent.ts — Department profile, notices, downloads, events, gallery, labs, achievements
 *
 * Consumed ONLY through src/services/hodService.ts
 */
...
export const mockDeptProfile: DepartmentProfile = {
  branch_id:       'CSE',
...
export const mockHodNotices: HodNotice[] = [
...
export const mockAttendanceSummary: AttendanceSummary[] = [
  { branch_id: 'CSE', semester: 5, section: 'A', total_students: 62, avg_attendance_pct: 84, below_75: 6, defaulters: [{ enrollment: '0901CS21005', name: 'Vikram Singh', pct: 62 }, { enrollment: '0901CS21011', name: 'Rohit Verma', pct: 68 }, { enrollment: '0901CS21014', name: 'Mohit Sharma', pct: 71 }] },
  { branch_id: 'CSE', semester: 5, section: 'B', total_students: 60, avg_attendance_pct: 82, below_75: 8, defaulters: [{ enrollment: '0901CS21003', name: 'Rahul Gupta', pct: 58 }, { enrollment: '0901CS21009', name: 'Sunny Tiwari', pct: 64 }] },
  { branch_id: 'CSE', semester: 3, section: 'A', total_students: 65, avg_attendance_pct: 88, below_75: 3, defaulters: [{ enrollment: '0901CS21008', name: 'Divya Dubey', pct: 73 }] },
]
...
export const mockDeptResultSummary: DeptResultSummary[] = [
...
export const mockHodDownloads: HodDownload[] = [
...
export const mockHodEvents: HodEvent[] = [
...
export const mockHodGallery: HodGalleryAlbum[] = [
...
export const mockHodLabs: HodLab[] = [
...
export const mockHodAchievements: HodAchievement[] = [
