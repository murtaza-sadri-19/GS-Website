      ...
      <section className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 bg-white rounded border border-slate-200 p-6 md:p-8 shadow-sm">
          ...
          {activeTab === 'faculty' && (() => {
            ...
            // Separate HOD (always first member) from the rest of the page
            const hodCard = facultyPage === 1 ? paginatedFaculty[0] : null
            const restFaculty = facultyPage === 1 ? paginatedFaculty.slice(1) : paginatedFaculty
            ...
            return (
              <div id="faculty-tab-header" className="space-y-6 scroll-mt-24">
                ...
                {/* ── HOD Card (full width, gold accent, always first on page 1) ── */}
                {hodCard && (
                  <div className="pt-2">
                      ...
                      <div className="flex-1 min-w-0 space-y-2.5">
                        ...
                        <div className="text-[11px] text-slate-550 space-y-1 font-sans font-medium">
                          ...
                          <p className="flex items-center gap-1 text-slate-500">
                            <Mail className="w-3 h-3 flex-shrink-0" />{hodCard.email}
                          </p>
                        </div>
                        <Link
                        ...
                        <div className="flex-1 min-w-0 space-y-2">
                          ...
                          <div className="text-[11px] text-slate-550 space-y-1 font-sans font-medium">
                            ...
                            <p className="flex items-center gap-1 text-slate-500 truncate">
                              <Mail className="w-3 h-3 flex-shrink-0" />{fac.email}
                            </p>
                          </div>
                        </div>
                      </div>
