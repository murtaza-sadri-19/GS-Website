  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center py-12 px-6 text-center bg-white">
      ...
      <div className="relative mb-8 group">
        ...
        <div className="relative w-36 h-36 bg-white border border-slate-200 rounded-full flex items-center justify-center shadow-sm group-hover:border-primary transition-colors duration-500">
          <svg
        ...
        <span className="absolute -bottom-1 right-2 bg-accent text-white font-semibold text-xs px-2 py-0.5 rounded shadow-sm font-display tracking-wider">
          404 ERROR
        </span>
      </div>
      ...
      {/* Help Disclosures */}
      <div className="mt-12 p-5 bg-brand-light border border-slate-200 rounded-md max-w-md flex items-start gap-3 text-left shadow-sm">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1 leading-relaxed">
            ...
            <Link to="/about/telephone-directory" className="text-primary hover:underline font-semibold">
              Telephone Directory
            </Link>{' '}
