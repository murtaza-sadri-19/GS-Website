  ...
  return (
    <div className="space-y-12 bg-white">
      ...
      <div className="border-b border-slate-200 pb-5">
        <span className="text-xs uppercase font-bold tracking-widest text-accent block mb-1">Campus Life</span>
      ...
      {data.affiliations && data.affiliations.length > 0 && (
        <div className="bg-slate-50 rounded border border-slate-200/80 p-6 border-l-2 border-l-[#0b2545]">
          <div className="space-y-6">
            <div>
              <span className="text-xs uppercase font-bold tracking-widest text-accent block mb-1">Guidelines & Certifications</span>
              <h3 className="text-xl font-display font-bold text-primary">Activity Guidelines</h3>
