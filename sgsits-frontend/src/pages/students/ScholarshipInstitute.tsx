...
const ScholarshipInstitute: React.FC<{ previewData?: any }> = ({ previewData }) => {
  const [fetchedData, setFetchedData] = useState<any>(null)
  useEffect(() => { if (!previewData) getScholarshipInstitute().then(setFetchedData) }, [previewData])
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border-b border-slate-200 pb-4">
        <h2 className="text-2xl md:text-3xl font-bold text-primary">Institute Scholarships</h2>
        <p className="text-sm text-slate-500 mt-1">Merit and need-based scholarships by SGSITS</p>
      </div>
