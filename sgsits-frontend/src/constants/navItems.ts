...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Applied Chemistry", path: "/departments/applied-chemistry" },
      {
        ...
        path: "/departments/applied-mathematics",
      },
      { label: "Applied Physics", path: "/departments/applied-physics" },
      {
        label: "Biomedical Engineering",
        path: "/departments/biomedical-engineering",
      },
      { label: "Civil Engineering", path: "/departments/civil-engineering" },
      {
        label: "Computer Engineering",
        path: "/departments/computer-engineering",
      },
      {
        label: "Computer Tech & Apps (CTA)",
        path: "/departments/computer-technology",
      },
      {
        label: "Electrical Engineering",
        path: "/departments/electrical-engineering",
      },
      {
        label: "Electronics & Instrumentation",
        path: "/departments/electronics-instrumentation",
      },
      {
        label: "Electronics & Telecomm",
        path: "/departments/electronics-telecommunication",
      },
      {
      ...
      },
      {
        ...
        path: "/departments/industrial-production",
      },
      {
      ...
      {
        label: "Management Studies (MBA)",
        path: "/departments/management-studies",
      },
      {
        label: "Mechanical Engineering",
        path: "/departments/mechanical-engineering",
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Institute Scholarships",
        path: "/students/scholarship/institute",
      },
