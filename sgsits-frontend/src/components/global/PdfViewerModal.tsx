...
const PdfViewerModal: React.FC<PdfViewerModalProps> = ({
  ...
  return (
    <div 
      className="fixed inset-0 z-[100] flex items-center justify-center bg-primary/75 backdrop-blur-md p-4 transition-all duration-300 animate-fadeIn"
      onClick={onClose}
    >
      <div 
      ...
      >
        {/* Header Bar */}
        <div className="flex items-center justify-between px-4 py-3 bg-primary text-white border-b border-slate-200">
        ...
        <div className="relative flex-1 bg-slate-50 flex flex-col overflow-hidden">
          ...
          <div className="bg-slate-100 border-t border-slate-200 px-4 py-2 flex items-center justify-between text-xs text-slate-500 font-medium font-sans shrink-0">
